...
\author{Chi-Wei, PENG}
\affiliation{%
  \institution{National Central University} %% 學校名稱
  \department{Student ID: 114423004}       %% 學號資訊
  \city{Zhongli}
  \country{Taiwan}
}
...
\affiliation{%
  ...
  \department{Student ID: 114423009}
  \city{Zhongli}
  \country{Taiwan}
}
...
\affiliation{%
  \institution{National Central University}
  \department{Student ID: 114423049}
  \city{Zhongli}
  \country{Taiwan}
}
...
\affiliation{%
  \institution{National Central University}
  \department{Student ID: 114423050}
  \city{Zhongli}
  \country{Taiwan}
}
...
\begin{table*}[t]
  ...
  \label{tab:datasets}
  \small
  \setlength{\tabcolsep}{10pt} % 增加欄位間距讓排版更寬鬆美觀
  \begin{tabular}{llrrrrrl}
    \toprule
    \textbf{Dataset}        & \textbf{Domain}       &
    \textbf{\#Inst.}        & \textbf{\#Feat.}      &
    \textbf{Min.}           & \textbf{Maj.}         &
    \textbf{IR}             & \textbf{Severity}     \\
    \midrule
    Phoneme                 & Speech recognition    & 5{,}404 & 5 & 1{,}586 & 3{,}818 &  2.41 & Mild     \\
    Yeast-1                 & Bioinformatics        & 1{,}484 & 8 &   429   & 1{,}055 &  2.46 & Mild     \\
    Yeast-3                 & Bioinformatics        & 1{,}484 & 8 &   163   & 1{,}321 &  8.10 & Moderate \\
    Shuttle-c0-vs-c4        & Aerospace             & 1{,}829 & 9 &   123   & 1{,}706 & 13.87 & Moderate \\
    Glass5                  & Material science      &   214   & 9 &     9   &   205   & 22.78 & Severe   \\
    Yeast-4                 & Bioinformatics        & 1{,}484 & 8 &    51   & 1{,}433 & 28.10 & Severe   \\
    Ecoli                   & Microbiology          &   281   & 7 &     7   &   274   & 39.14 & Extreme  \\
    Yeast-6                 & Bioinformatics        & 1{,}484 & 8 &    35   & 1{,}449 & 41.40 & Extreme  \\
    \bottomrule
  \end{tabular}
\end{table*}
% ---------- End Table 1 ----------
