...
\begin{table*}[t]
  \centering
  \caption{Experimental Results Summary across all methods and datasets.}
  ...
  \begin{tabular}{llcccccccccc}
    ...
    \cmidrule{2-11}
    & \multirow{4}{*}{\begin{tabular}[c]{@{}l@{}}Cost-Sensitive+\\RandomForest\end{tabular}} 
    ...
    \cmidrule{2-11}
    & \multirow{4}{*}{\begin{tabular}[c]{@{}l@{}}Cost-Sensitive+\\XGBoost\end{tabular}} 
    ...
    \cmidrule{2-11}
    & \multirow{4}{*}{\begin{tabular}[c]{@{}l@{}}Cost-Sensitive+\\AdaBoost\end{tabular}} 
    ...
    \midrule
    \multirow{24}{*}{Hybrid Method} & \multirow{4}{*}{AdaBoost (depth=5)} 
